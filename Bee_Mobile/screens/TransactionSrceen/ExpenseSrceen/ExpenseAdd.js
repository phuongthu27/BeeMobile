...
const ExpenseAdd = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.card}>
      <TouchableOpacity style={styles.listButton} onPress={() => setShowExpenseList(!showExpenseList)}>
        <Ionicons name="ellipsis-horizontal" size={24} color="#5A5DD1" />
      </TouchableOpacity>

      {showExpenseList && (
        <TouchableOpacity onPress={() => navigation.navigate('ExpenseList')} style={styles.listContainer}>
          <Text style={styles.listText}>Sổ chi tiêu</Text>
        </TouchableOpacity>
      )}
